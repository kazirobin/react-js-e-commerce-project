  ...
  return (
    ...
    <div className="group p-2 ml-5">
      ...
      <div className="absolute hidden group-hover:flex flex-col font-semibold">
        <Link className="flex gap-3 hover:gap-5 hover:text-green-600 border-b-1 border-gray-300 ps-4 pe-20 py-2">
    ...
    <div className="flex content-between border border-gray-300 rounded-full  w-5/12  ps-6">
      <input type="text" name="" id="" className="focus:outline-none" placeholder="Type Your Products ..."/>
      <button className="flex ml-auto items-center gap-2 cursor-pointer bg-amber-400 hover:bg-green-600 hover:text-white p-2 ps-6 overflow-hidden rounded-r-full font-semibold">Search <RiSearchLine/></button>
    </div>
    </>
  );
};
