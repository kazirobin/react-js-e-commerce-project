...
const menuItems = [
  {
    menu: "Home",
    sub: [
      { menu: "Home 1", src: "home-1" },
      { menu: "Home 2", src: "home-2" },
      { menu: "Home 3", src: "home-3" },
      { menu: "Home 4", src: "home-4" },
    ],
  },
  {
    menu: "Pages",
    sub: [
      { menu: "Pages 1", src: "home-1" },
      { menu: "Home 2", src: "home-2" },
    ],
  },
  {
    menu: "Shop",
    sub: [
      { menu: "Shop 1",sub:[{menu:"Layout 1",src:"layout-1"},{menu:"Layout 2",src:"layout-2"}] },
      { menu: "Shop 2" },
    ],
  },
  {
              ...
              {openMenus[index] && (
                <div className="">
                  {items.sub.map((subItem, subItemIndex) => (
                    <div
                      className="flex items-center group text-sm font-semibold ps-4 py-1"
                      key={subItemIndex}
                    >
                      <div
                      ...
                      ></div>
                      <Link
                        className="*:first:text-green-500 group-hover:ps-1.5 group-focus:ps-1.5 group-active:ps-1.5 transition-all"
                        onTouchStart={(e) => {
                          e.currentTarget.classList.add("ps-1.5");
                        }}
                        ontouchend={(e) => {
                          e.currentTarget.classList.remove("ps-1.5");
                        }}
                        to={subItem.src}
                      >
                        {subItem.menu}
