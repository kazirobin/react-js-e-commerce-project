...
const Banner = () => {
  ...
  return (
    <div className="px-3 md:px-10 mx-auto my-4 grid gap-4 md:grid-cols-2">
      <div className="h-auto bg-center bg-no-repeat bg-[length:100%] hover:bg-[length:105%] rounded-2xl overflow-hidden transition-all" style={{backgroundImage:`url(${images[1].BannerImage.leftSide})`}}>
      ...
      <div className="grid gap-4">
        <div className="h-70 sm:col-span-2  bg-[length:100%] hover:bg-[length:105%]  bg-no-repeat rounded-2xl overflow-hidden ps-6 pt-10 transition-all" style={{backgroundPosition:"50%", backgroundImage:`url(${images[1].BannerImage.rightTop})`}}>
        ...
        <div className="h-90 md:h-60 bg-no-repeat bg-center  bg-[length:100%] hover:bg-[length:105%]  rounded-2xl overflow-hidden text-center text-white font-semibold transition-all" style={{backgroundImage:`url(${images[1].BannerImage.rightBottomLeft})`}}>
        ...
        <div className="p-5 h-90 md:h-60 bg-no-repeat bg-center bg-[length:100%] hover:bg-[length:105%]  rounded-2xl overflow-hidden transition-all" style={{backgroundImage:`url(${images[1].BannerImage.rightBottomRight})`}}>
